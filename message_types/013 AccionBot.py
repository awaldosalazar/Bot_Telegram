...
def echo(update: Update, context: CallbackContext) -> None:
    ...
    update.message.reply_video(open("E:\\ProyectosPersonales\\Udemy\\TelegramBot\\Grabaciones\\data\\movie.mp4", 'rb'), caption="Un video de un oso", reply_to_message_id=update.message.message_id)
